...
public class EntityNotSupportedException extends BaseException {
    ...
    public EntityNotSupportedException(String message) {
        super(message);
    }

    public EntityNotSupportedException(Throwable cause) {
        super(cause);
    }

    public EntityNotSupportedException(String message, Throwable cause) {
        super(message, cause);
    }
}
